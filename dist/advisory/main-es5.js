...
var Api = /** @class */ (function () {
    ...
    Api.prototype.formData = function (url, data) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
...
var CommonService = /** @class */ (function () {
    function CommonService(toastr, spinner) {
        this.toastr = toastr;
        this.spinner = spinner;
    }
    CommonService.prototype.succ = function (msg) {
        this.toastr.success(msg);
    };
    CommonService.prototype.err = function (msg) {
...
var AddQuestionaireComponent = /** @class */ (function () {
    function AddQuestionaireComponent(fb, api, commonService, router) {
        this.fb = fb;
        this.api = api;
        this.commonService = commonService;
        this.router = router;
    }
    AddQuestionaireComponent.prototype.ngOnInit = function () {
    ...
    AddQuestionaireComponent.prototype.initQuestion = function () {
    ...
    AddQuestionaireComponent.prototype.initAnswer = function () {
        return this.fb.group({
    ...
    AddQuestionaireComponent.prototype.addQuestion = function () {
        var control = this.form.controls['questions'];
        control.push(this.initQuestion());
    };
    AddQuestionaireComponent.prototype.removeQuestion = function (ix) {
        var control = this.form.controls['questions'];
        control.removeAt(ix);
    };
    AddQuestionaireComponent.prototype.addAnswer = function (ix) {
        var control = this.form.controls['questions'].at(ix).get('answers');
        control.push(this.initAnswer());
    };
    AddQuestionaireComponent.prototype.removeAnswer = function (ix, iy) {
        console.log(ix + ' / ' + iy);
    ...
    AddQuestionaireComponent.prototype.move = function (shift, currentIndex) {
        var rules = this.form.controls['questions'];
        ...
        var currentGroup = this.form.controls['questions'].at(currentIndex);
        rules.removeAt(currentIndex);
        ;
        rules.insert(newIndex, currentGroup);
    };
    AddQuestionaireComponent.prototype.numberOnly = function (event) {
    ...
    AddQuestionaireComponent.prototype.saveQuestionaire = function () {
        var _this = this;
        ...
        this.api.post("addQuestionnaire", data).subscribe(function (result) {
            if (result.status == 200) {
                _this.commonService.succ(result.message);
                _this.router.navigate(['matching-portfolio/' + result.data._id]);
            }
            else {
                _this.commonService.err(result.message);
            }
        }, function (error) {
            console.log({ error: error });
        });
    };
    AddQuestionaireComponent.ctorParameters = function () { return [
    ...
    return AddQuestionaireComponent;
}());
...
var AddTickerComponent = /** @class */ (function () {
    function AddTickerComponent(fb, commonService, api, router, http, spinner) {
        this.fb = fb;
        this.commonService = commonService;
        this.api = api;
        this.router = router;
    ...
    AddTickerComponent.prototype.ngOnInit = function () {
        this.spinner.show();
        this.form = this.fb.group({
            "title": ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]
        });
    ...
    AddTickerComponent.prototype.searchTicker = function () {
        var _this = this;
        ...
        this.api.post("getOrbisTicker", data).subscribe(function (result) {
            //console.log(result)
            if (result.status == 200) {
                // if (result.data[0].isin) {
                if (result.data[0]) {
                    _this.ticketData = result.data[0];
                    $('#refer').modal('show');
                    _this.patchTickerValue(_this.ticketData, result.result);
                }
                else {
    ...
    AddTickerComponent.prototype.patchTickerValue = function (data, result) {
        if (data) {
    ...
    AddTickerComponent.prototype.onFileSelected = function (event) {
        var _this = this;
        ...
        this.http.post(this.url + "uploadImage", fd, {
            ...
            if (event.type === _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpEventType"].UploadProgress) {
                ...
                _this.addTickerform.value.tickerImage = event.body['data'];
            }
            else {
    ...
    AddTickerComponent.prototype.saveData = function () {
        var _this = this;
        this.spinner.show();
        ...
        this.api.post("addTicker", this.addTickerform.value).subscribe(function (result) {
            if (result.status == 200) {
                _this.commonService.succ(result.message);
    ...
    AddTickerComponent.prototype.getTickerList = function () {
        var _this = this;
        this.api.get('getTickerList').subscribe(function (result) {
            console.log('resultresultresult', result);
            if (result.status == 200) {
                _this.getTickerListData = result.data;
                console.log('getTickerListDatagetTickerListDatagetTickerListDatagetTickerListData', _this.getTickerListData);
                _this.spinner.hide();
            }
            else {
            }
    ...
    AddTickerComponent.prototype.closePops = function (id) {
        console.log(id);
        $("#" + id).modal('hide');
    };
    AddTickerComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
...
/* harmony import */ var ng_apexcharts__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ng-apexcharts */ "./node_modules/ng-apexcharts/fesm5/ng-apexcharts.js");
...
var CategoryDetailComponent = /** @class */ (function () {
    function CategoryDetailComponent(location) {
    ...
    CategoryDetailComponent.prototype.randomizeArray = function (arg) {
        var array = arg.slice();
    ...
    CategoryDetailComponent.prototype.backClicked = function () {
...
var ClientDetail1Component = /** @class */ (function () {
    function ClientDetail1Component() {
        this.chartOptions = {
    ...
    ClientDetail1Component.prototype.ngOnInit = function () {
        var options = {
            chart: {
                type: 'donut',
            },
    ...
    ClientDetail1Component.prototype.graph1 = function () {
        /* Chart code */
        // Themes begin
        ...
        // Themes end
        // Create chart
        var chart = _amcharts_amcharts4_core__WEBPACK_IMPORTED_MODULE_3__["create"]("graphdiv", _amcharts_amcharts4_charts__WEBPACK_IMPORTED_MODULE_4__["XYChart"]);
    ...
    ClientDetail1Component.prototype.graph2 = function () {
        /* Chart code */
        // Themes begin
        _amcharts_amcharts4_core__WEBPACK_IMPORTED_MODULE_3__["useTheme"](_amcharts_amcharts4_themes_animated__WEBPACK_IMPORTED_MODULE_5__["default"]);
        // Themes end
        // Create chart
        var chart = _amcharts_amcharts4_core__WEBPACK_IMPORTED_MODULE_3__["create"]("graphdivTwo", _amcharts_amcharts4_charts__WEBPACK_IMPORTED_MODULE_4__["XYChart"]);
        chart.paddingRight = 20;
        chart.data = generateChartData();
        var dateAxis = chart.xAxes.push(new _amcharts_amcharts4_charts__WEBPACK_IMPORTED_MODULE_4__["DateAxis"]());
        dateAxis.baseInterval = {
...
var ComplianceDetailComponent = /** @class */ (function () {
    function ComplianceDetailComponent() {
        this.commonLineSparklineOptions = {
            chart: {
                type: "line",
                width: 100,
    ...
    ComplianceDetailComponent.prototype.randomizeArray = function (arg) {
        var array = arg.slice();
        var currentIndex = array.length, temporaryValue, randomIndex;
        while (0 !== currentIndex) {
            randomIndex = Math.floor(Math.random() * currentIndex);
    ...
    ComplianceDetailComponent.prototype.ngOnInit = function () {
    };
    ...
    return ComplianceDetailComponent;
}());
...
var ComplianceComponent = /** @class */ (function () {
    function ComplianceComponent(fb, api, commonService, router) {
        this.fb = fb;
        this.api = api;
        this.commonService = commonService;
        this.router = router;
    ...
    ComplianceComponent.prototype.ngOnInit = function () {
        this.form = this.fb.group({
    ...
    ComplianceComponent.prototype.saveFees = function () {
        var _this = this;
        if (this.form.invalid) {
            this.commonService.err("All fields are required.");
            return;
        ...
        console.log(data);
        this.api.post("addPlan", data).subscribe(function (result) {
            if (result.status == 200) {
                _this.commonService.succ(result.message);
                _this.router.navigate(['compliance']);
                _this.form.reset();
            }
            else {
                _this.commonService.err(result.message);
    ...
    ComplianceComponent.prototype.changeDuration = function (duration) {
    ...
    ComplianceComponent.prototype.changeBillTime = function (billTime) {
    ...
    ComplianceComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _api_api_service__WEBPACK_IMPORTED_MODULE_3__["Api"] },
        { type: _api_comman_service__WEBPACK_IMPORTED_MODULE_4__["CommonService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] }
...
var CreateModelComponent = /** @class */ (function () {
    function CreateModelComponent(location, fb, api, commonService, http, router, spinner) {
        this.location = location;
        this.fb = fb;
        this.api = api;
        this.commonService = commonService;
    ...
    CreateModelComponent.prototype.backClicked = function () {
        // localStorage.setItem("fromInvesting","true")
        this.location.back();
    };
    CreateModelComponent.prototype.onSelect = function (event) {
    ...
    CreateModelComponent.prototype.numberOnly = function (event) {
    ...
    CreateModelComponent.prototype.addModel = function () {
        var _this = this;
        ...
        this.api.post("createModel", data).subscribe(function (result) {
            if (result.status == 200) {
                _this.commonService.succ(result.message);
                _this.router.navigate(['investing']);
            }
            else {
                _this.commonService.succ('Something went wrong');
            }
            _this.spinner.hide();
        }, function (error) {
            console.log({ error: error });
    ...
    CreateModelComponent.prototype.getorbisModel = function () {
        var _this = this;
        this.api.get('getOrbisModels').subscribe(function (result) {
            ...
            if (result.status == 200) {
                ...
                if (result.data[0]) {
                    result.data.forEach(function (value, key) {
                        ...
                        // }
                        filterResult_1.push(value);
                    });
                }
                _this.orbisModelDetail = filterResult_1;
            }
            _this.isShowSpinner = false;
            _this.spinner.hide();
            console.log('this.getorbisModelhhhhh', _this.orbisModelDetail);
        }, function (error) {
            console.log({ error: error });
        });
    };
    CreateModelComponent.ctorParameters = function () { return [
        { type: _angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"] },
...
var CreatePortfolioComponent = /** @class */ (function () {
    function CreatePortfolioComponent(fb, api, commonService, router) {
        this.fb = fb;
        this.api = api;
        this.commonService = commonService;
        this.router = router;
    ...
    CreatePortfolioComponent.prototype.ngOnInit = function () {
        $(document).on('click', 'button.minus', function () {
            $(this).parents('.inputBox').find('.formControl').attr('value', 0);
        });
        this.getModelList();
    ...
    CreatePortfolioComponent.prototype.getModelList = function () {
        var _this = this;
        this.api.get('modelList').subscribe(function (result) {
            //console.log('resultresultresult', result)
            if (result.status == 200) {
                var filterResult_1 = [];
                result.data.forEach(function (value, key) {
                ...
                _this.modelList = filterResult_1;
            }
        }, function (error) {
            console.log({ error: error });
        });
    };
    CreatePortfolioComponent.prototype.addPortfolio = function () {
        var _this = this;
        ...
        this.api.post("createPortfolio", data).subscribe(function (result) {
            if (result.status == 200) {
                _this.commonService.succ(result.message);
                _this.router.navigate(['investing']);
            }
    ...
    CreatePortfolioComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _api_api_service__WEBPACK_IMPORTED_MODULE_4__["Api"] },
        { type: _api_comman_service__WEBPACK_IMPORTED_MODULE_5__["CommonService"] },
    ...
    return CreatePortfolioComponent;
}());
...
var CreateThematicComponent = /** @class */ (function () {
    function CreateThematicComponent(location, fb, api, commonService, http, router, spinner) {
        this.location = location;
        this.fb = fb;
        this.api = api;
        this.commonService = commonService;
    ...
    CreateThematicComponent.prototype.ngOnInit = function () {
        this.spinner.show();
        this.getorbisModel();
    };
    CreateThematicComponent.prototype.backClicked = function () {
        // localStorage.setItem("fromInvesting","true")
        this.location.back();
    };
    CreateThematicComponent.prototype.getorbisModel = function () {
        var _this = this;
        this.api.get('modelList').subscribe(function (result) {
            //console.log('resultresultresult', result)
            if (result.status == 200) {
    ...
    CreateThematicComponent.prototype.onFileSelected = function (event) {
        var _this = this;
        this.selectedFile = event.target.files[0];
        console.log(this.selectedFile);
        var fd = new FormData();
        ...
        this.http.post(this.url + "uploadImage", fd, {
            ...
            if (event.type === _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpEventType"].UploadProgress) {
                _this.uploadTimer = Math.round(event.loaded / event.total * 100);
                console.log("Upload Progress:" + _this.uploadTimer + "%");
            }
            else if (event.type === _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpEventType"].Response) {
                _this.uploadedImageUrl = event.body['data'];
            }
            else {
                console.log("Uploading Completed");
            }
    ...
    CreateThematicComponent.prototype.addThematic = function () {
        var _this = this;
        ...
        this.api.post("createThematic", data).subscribe(function (result) {
            if (result.status == 200) {
                _this.commonService.succ(result.message);
                _this.router.navigate(['investing']);
            }
    ...
    CreateThematicComponent.ctorParameters = function () { return [
    ...
    return CreateThematicComponent;
}());
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.summaryClick = function () {
    ...
    DashboardComponent.prototype.clientClick = function () {
    ...
    DashboardComponent.prototype.investingClick = function () {
        this.summaryOverViewTab = false;
        this.clientTab = false;
    ...
    DashboardComponent.prototype.transactionClick = function () {
        this.summaryOverViewTab = false;
        this.clientTab = false;
        this.investingTab = false;
    ...
    DashboardComponent.prototype.checkFun = function () {
        var x = localStorage.getItem("summaryOverViewTab");
        if (x == "false") {
...
var EditQuestionaireComponent = /** @class */ (function () {
    function EditQuestionaireComponent(api, activatedRoute, fb, commonService, router, spinner) {
        this.api = api;
    ...
    EditQuestionaireComponent.prototype.ngOnInit = function () {
        this.spinner.show();
    ...
    EditQuestionaireComponent.prototype.getQuestionaireDetail = function () {
        var _this = this;
        this.activatedRoute.params.subscribe(function (params) {
            console.log(params['id']);
            _this.api.get('getQuestionaireDetail/' + params['id']).subscribe(function (result) {
                console.log('resultresultresult', result.data[0]);
                if (result.status == 200) {
                    _this.questionDetail = result.data[0];
                    _this.patchQuestionValue(_this.questionDetail);
                }
                _this.spinner.hide();
            }, function (error) {
                console.log({ error: error });
    ...
    EditQuestionaireComponent.prototype.initQuestion = function () {
        return this.fb.group({
            'question_id': [''],
            'question': ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            'answers': this.fb.array([
    ...
    EditQuestionaireComponent.prototype.initAnswer = function () {
        return this.fb.group({
            'answer_id': [''],
            'answer': ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            'value': ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern("^[0-9]*$")]]
    ...
    EditQuestionaireComponent.prototype.patchQuestionValue = function (data) {
        var _this = this;
        if (data) {
            if (data.questions) {
                var questionResult_1 = [];
                data.questions.forEach(function (question, index) {
                    ...
                    questionResult_1.push(questionObj);
                });
                var newForm = {
                ...
                this.form.controls['questions'].patchValue(questionResult_1);
                console.log('newFormnewFormnewForm', this.form.value);
            }
        }
    };
    EditQuestionaireComponent.prototype.addQuestion = function () {
        var control = this.form.controls['questions'];
        control.push(this.initQuestion());
    };
    EditQuestionaireComponent.prototype.removeQuestion = function (ix) {
        var control = this.form.controls['questions'];
        control.removeAt(ix);
    };
    EditQuestionaireComponent.prototype.addAnswer = function (ix) {
        var control = this.form.controls['questions'].at(ix).get('answers');
        control.push(this.initAnswer());
    };
    EditQuestionaireComponent.prototype.removeAnswer = function (ix, iy) {
        console.log(ix + ' / ' + iy);
        console.log(this.form.controls['questions'].at(ix).get('answers'));
        var control = this.form.controls['questions'].at(ix).get('answers');
        control.removeAt(iy);
    ...
    // Move form control item up or down in the array
    EditQuestionaireComponent.prototype.move = function (shift, currentIndex) {
        var rules = this.form.controls['questions'];
        var newIndex = currentIndex + shift;
        if (newIndex === -1) {
            newIndex = this.form.controls['questions'].length - 1;
    ...
    EditQuestionaireComponent.prototype.checkMaxData = function (event) {
        var MaxData = Math.max.apply(Math, this.form.value.questions[0].answers.map(function (o) { return o.value; }));
        var minData = Math.min.apply(Math, this.form.value.questions[0].answers.map(function (o) { return o.value; }));
        console.log(MaxData, minData);
    };
    EditQuestionaireComponent.prototype.numberOnly = function (event) {
        var charCode = (event.which) ? event.which : event.keyCode;
        if (charCode > 31 && (charCode < 48 || charCode > 57)) {
            return false;
        }
    ...
    EditQuestionaireComponent.prototype.saveQuestionaire = function () {
        var _this = this;
        // if (this.form.invalid) {
        //   return;
        // }
        ...
        this.api.post("editQuestionnaire", data).subscribe(function (result) {
            if (result.status == 200) {
                _this.commonService.succ(result.message);
                _this.router.navigate(['matching-portfolio/' + _this.form.value.questionnaire_id]);
            }
            else {
                _this.commonService.err(result.message);
            }
    ...
    EditQuestionaireComponent.ctorParameters = function () { return [
        { type: _api_api_service__WEBPACK_IMPORTED_MODULE_3__["Api"] },
    ...
    return EditQuestionaireComponent;
}());
...
var EditThematicComponent = /** @class */ (function () {
    function EditThematicComponent(location, fb, api, commonService, http, router, spinner, activatedRoute) {
        this.location = location;
        this.fb = fb;
        this.api = api;
        this.commonService = commonService;
    ...
    EditThematicComponent.prototype.ngOnInit = function () {
        this.spinner.show();
        this.getorbisModel();
        this.getThematicDetail();
    };
    EditThematicComponent.prototype.backClicked = function () {
        // localStorage.setItem("fromInvesting","true")
        this.location.back();
    };
    EditThematicComponent.prototype.getThematicDetail = function () {
        var _this = this;
        this.activatedRoute.params.subscribe(function (params) {
            console.log(params['id']);
            _this.api.get('thematicDetail/' + params['id']).subscribe(function (result) {
                console.log('resultresultresult', result);
                if (result.status == 200) {
                    if (result.data) {
                        _this.thematicDetail = result.data[0];
                        if (_this.thematicDetail.models[0]) {
                            _this.assignedModelDetail = _this.thematicDetail.models[0];
                        }
                        console.log('this.thematicDetailthis.thematicDetail', _this.thematicDetail);
                        var newForm = {
                            "thematicId": _this.thematicDetail._id,
                            "models": _this.thematicDetail.modelId,
                            "name": _this.thematicDetail.thematicName,
                            "description": _this.thematicDetail.thematicDescription,
                        };
                        _this.thematicForm.patchValue(newForm);
                    }
                }
                else {
                    _this.commonService.err("Thematic not found");
                    _this.router.navigate(['investing']);
                }
                _this.isShowSpinner = false;
            }, function (error) {
    ...
    EditThematicComponent.prototype.getorbisModel = function () {
        var _this = this;
        this.api.get('modelList').subscribe(function (result) {
            //console.log('resultresultresult', result)
            if (result.status == 200) {
    ...
    EditThematicComponent.prototype.onFileSelected = function (event) {
        var _this = this;
        this.selectedFile = event.target.files[0];
        console.log(this.selectedFile);
        var fd = new FormData();
    ...
    EditThematicComponent.prototype.addThematic = function () {
        var _this = this;
        //console.log("helo", this.thematicForm.value)
        if (this.thematicForm.invalid) {
            return;
        ...
        console.log('datadatadatadata', data);
        this.api.post("editThematic", data).subscribe(function (result) {
            if (result.status == 200) {
                _this.commonService.succ(result.message);
                _this.router.navigate(['investing']);
            }
    ...
    EditThematicComponent.ctorParameters = function () { return [
        { type: _angular_common__WEBPACK_IMPORTED_MODULE_3__["Location"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _api_api_service__WEBPACK_IMPORTED_MODULE_4__["Api"] },
        { type: _api_comman_service__WEBPACK_IMPORTED_MODULE_5__["CommonService"] },
...
var FreeStockComponent = /** @class */ (function () {
    function FreeStockComponent(api) {
        this.api = api;
        this.referList = [];
    }
    FreeStockComponent.prototype.ngOnInit = function () {
        this.stockList();
    };
    FreeStockComponent.prototype.stockList = function () {
        var _this = this;
        this.api.get('referList').subscribe(function (result) {
            if (result.status == 200) {
                _this.referList = result.data;
            }
            else {
            }
        }, function (error) {
    ...
    FreeStockComponent.ctorParameters = function () { return [
...
var InvestCashComponent = /** @class */ (function () {
    function InvestCashComponent(location) {
        this.location = location;
    }
    InvestCashComponent.prototype.ngOnInit = function () {
    };
    InvestCashComponent.prototype.backClicked = function () {
        // localStorage.setItem("fromInvesting","true")
        this.location.back();
    };
    InvestCashComponent.ctorParameters = function () { return [
        { type: _angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"] }
    ]; };
...
var InvestingComponent = /** @class */ (function () {
    function InvestingComponent(api, spinner) {
        this.api = api;
        this.spinner = spinner;
        this.modelList = [];
        this.portfolioList = [];
    ...
    InvestingComponent.prototype.ngOnInit = function () {
        this.spinner.show();
        this.getModelList();
        this.getPortfolioList();
        this.getThematicList();
    };
    InvestingComponent.prototype.getModelList = function () {
        var _this = this;
        this.api.get('modelList').subscribe(function (result) {
            //console.log('resultresultresult', result)
            if (result.status == 200) {
    ...
    InvestingComponent.prototype.getPortfolioList = function () {
        var _this = this;
        this.api.get('portfolioList').subscribe(function (result) {
            //console.log('resultresultresult', result)
            if (result.status == 200) {
                _this.portfolioList = result.data;
            }
            else {
            }
        }, function (error) {
    ...
    InvestingComponent.prototype.getThematicList = function () {
        var _this = this;
        this.api.get('thematicList').subscribe(function (result) {
            if (result.status == 200) {
                _this.thematicList = result.data;
                // console.log('thematicListthematicListthematicListthematicList', this.thematicList)
            }
        });
    };
    InvestingComponent.prototype.canActiveTabs = function (a, b) {
        console.log(a);
        console.log(b);
    ...
    InvestingComponent.ctorParameters = function () { return [
        { type: _api_api_service__WEBPACK_IMPORTED_MODULE_2__["Api"] },
        { type: ngx_spinner__WEBPACK_IMPORTED_MODULE_3__["NgxSpinnerService"] }
    ]; };
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(fb, router, api, commonService) {
        this.fb = fb;
        this.router = router;
        this.api = api;
        this.commonService = commonService;
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.api.post("adminLogin", data).subscribe(function (result) {
            if (result.status == 200) {
                _this.commonService.succ(result.message);
...
var ManagedAccountDetailComponent = /** @class */ (function () {
    function ManagedAccountDetailComponent() {
    }
    ManagedAccountDetailComponent.prototype.ngOnInit = function () {
        var options = {
    ...
    return ManagedAccountDetailComponent;
}());
...
var MatchingPortfolioComponent = /** @class */ (function () {
    function MatchingPortfolioComponent(fb, location, api, activatedRoute, commonService, router, spinner) {
        this.fb = fb;
        this.location = location;
        this.api = api;
        this.activatedRoute = activatedRoute;
    ...
    MatchingPortfolioComponent.prototype.ngOnInit = function () {
        // $(document).ready(function () {
        //   alert("sssssssss");
        // })
        this.spinner.show();
    ...
    MatchingPortfolioComponent.prototype.getMatchedPortfolio = function () {
        var _this = this;
        this.activatedRoute.params.subscribe(function (params) {
            console.log(params['id']);
            _this.api.get('getQuestionairePortfolio/' + params['id']).subscribe(function (result) {
                console.log('xxx', result);
                if (result.status == 200) {
                    if (result.data) {
                        _this.questionDetail = result.data;
                        _this.modelDetail = _this.questionDetail;
                        console.log('this.modelDetail', _this.modelDetail);
                    }
                    else {
                        _this.commonService.err("Questionaire not found.");
    ...
    MatchingPortfolioComponent.prototype.getPortfolioList = function () {
        var _this = this;
        this.api.get('portfolioList').subscribe(function (result) {
            //console.log('resultresultresult', result)
            if (result.status == 200) {
    ...
    MatchingPortfolioComponent.prototype.getorbisModel = function () {
        var _this = this;
        this.activatedRoute.params.subscribe(function (params) {
            _this.api.get('getOrbisModels').subscribe(function (result) {
    ...
    MatchingPortfolioComponent.prototype.numberOnly = function (event) {
        console.log("sssssssss");
        var charCode = (event.which) ? event.which : event.keyCode;
        if (charCode > 31 && (charCode < 48 || charCode > 57)) {
            return false;
    ...
    MatchingPortfolioComponent.prototype.closePops = function () {
        $('#refer').modal('hide');
    };
    MatchingPortfolioComponent.prototype.saveData = function () {
        var _this = this;
        console.log('this.form.value', this.form.value);
        // return true;
        var questionnaire_id = this.activatedRoute.params.subscribe(function (params) {
            var result = _this.orbisModelDetail.find(function (obj) {
                return obj.id == _this.form.value.models;
            });
            var reqData = {
                questionnaire_id: params['id'],
                portfolioId: _this.form.value.models,
                minScore: _this.form.value.startrange,
                maxScore: _this.form.value.endrange
            };
            console.log('newDatanewDatanewDatanewData', reqData);
            _this.api.post("assignedPortfolio", reqData).subscribe(function (result) {
                if (result.status == 200) {
                    _this.commonService.succ(result.message);
                    _this.router.navigate(['matching-portfolio/' + params['id']]);
                    _this.getMatchedPortfolio();
                    $('#refer').modal('hide');
                }
                else {
                    _this.commonService.err(result.message);
    ...
    MatchingPortfolioComponent.prototype.deletePortfolio = function (data) {
        var _this = this;
        ...
        this.activatedRoute.params.subscribe(function (params) {
            ...
            _this.api.post("deletePortfolio", newData).subscribe(function (result) {
                if (result.status == 200) {
                    _this.commonService.succ(result.message);
                    _this.router.navigate(['matching-portfolio/' + params['id']]);
                    _this.getMatchedPortfolio();
                    console.log('newData', _this.questionDetail);
                }
                else {
                    _this.commonService.err(result.message);
                }
    ...
    MatchingPortfolioComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    ...
    return MatchingPortfolioComponent;
}());
...
var ModelDetailComponent = /** @class */ (function () {
    function ModelDetailComponent(location, api, activatedRoute, spinner, commonService, router, fb) {
        this.location = location;
        this.api = api;
        this.activatedRoute = activatedRoute;
        this.spinner = spinner;
    ...
    // this.location.back()
    // }
    ModelDetailComponent.prototype.backClicked = function () {
        localStorage.setItem("fromInvesting", "true");
        this.location.back();
    };
    ModelDetailComponent.prototype.getModelDetail = function () {
        var _this = this;
        this.activatedRoute.params.subscribe(function (params) {
            console.log(params['id']);
            _this.api.get('modelDetail/' + params['id']).subscribe(function (result) {
                console.log('resultresultresult', result);
                if (result.status == 200) {
                    if (result.data) {
                        _this.modelDetail = result.data;
                        console.log('this.thematicDetailthis.thematicDetail', _this.modelDetail);
                    }
                }
                else {
                    _this.commonService.err(result.message);
    ...
    ModelDetailComponent.prototype.searchTicker = function () {
        var _this = this;
        console.log('hiiii');
    ...
    ModelDetailComponent.prototype.saveData = function (a, b) {
        var _this = this;
        if (!a.value) {
        ...
        this.activatedRoute.params.subscribe(function (params) {
            var data = {
                holdingType: a.value,
                targetValue: b.value,
                symbol: _this.ticketData.symbol,
                tickerImage: _this.ticketData.tickerImage,
                companyName: _this.ticketData.companyName,
                latestPrice: _this.ticketData.latestPrice,
                upperValue: _this.ticketData.upperValue,
                lowerupperValue: _this.ticketData.lowerupperValue
            };
            var postData = {
                model_id: params['id'],
                models: data,
            ...
            _this.spinner.show();
            _this.api.post("addModelHolding", postData).subscribe(function (result) {
                if (result.status == 200) {
                    _this.commonService.succ(result.message);
    ...
    ModelDetailComponent.prototype.deleteHolding = function (data) {
        var _this = this;
        if (confirm("Are you sure to delete ")) {
            this.activatedRoute.params.subscribe(function (params) {
                ...
                _this.api.post("deleteModelHolding", newData).subscribe(function (result) {
                    if (result.status == 200) {
                        _this.commonService.succ(result.message);
                        _this.getModelDetail();
                    }
    ...
    ModelDetailComponent.prototype.deleteModels = function (data) {
        var _this = this;
        if (confirm("Are you sure to delete ")) {
            this.activatedRoute.params.subscribe(function (params) {
                var newData = {
                ...
                _this.api.post("deleteModel", newData).subscribe(function (result) {
                    if (result.status == 200) {
                        _this.commonService.succ(result.message);
                        _this.router.navigate(['investing']);
                    }
...
var CustomPipe = /** @class */ (function () {
    ...
    CustomPipe.prototype.transform = function (value, index) {
...
var PortfolioDetailEditComponent = /** @class */ (function () {
    function PortfolioDetailEditComponent(location, activatedRoute, router, api, commonService, fb) {
        this.location = location;
        this.activatedRoute = activatedRoute;
        this.router = router;
        this.api = api;
    ...
    PortfolioDetailEditComponent.prototype.ngOnInit = function () {
        var options = {
            series: [44, 55, 41, 17, 15],
            chart: {
                type: 'donut',
    ...
    PortfolioDetailEditComponent.prototype.getModelList = function () {
        var _this = this;
        this.api.get('modelList').subscribe(function (result) {
            //console.log('resultresultresult', result)
            if (result.status == 200) {
    ...
    PortfolioDetailEditComponent.prototype.getPortfolioDetail = function () {
        var _this = this;
        this.activatedRoute.params.subscribe(function (params) {
            console.log(params['id']);
            _this.api.get('portfolioDetail/' + params['id']).subscribe(function (result) {
                console.log('resultresultresult', result);
                if (result.status == 200) {
                    if (result.data) {
                        _this.portfolioDetail = result.data[0];
                        if (_this.portfolioDetail.models[0]) {
                            _this.assignedModelDetail = _this.portfolioDetail.models[0];
                        }
                        var newForm = {
                            "portfolioId": _this.portfolioDetail._id,
                            "modelId": _this.portfolioDetail.modelId,
                            "name": _this.portfolioDetail.name,
                            "riskLevel": _this.portfolioDetail.riskLevel,
                            "drift": _this.portfolioDetail.drift,
                            "description": _this.portfolioDetail.description
                        };
                        _this.portfolioFrom.patchValue(newForm);
                        console.log('this.portfolioFromthis.portfolioFromthis.portfolioFromthis.portfolioFrom', _this.portfolioFrom.value);
                    }
                }
                else {
                    _this.commonService.err(result.message);
    ...
    PortfolioDetailEditComponent.prototype.addPortfolio = function () {
        var _this = this;
        if (this.portfolioFrom.invalid) {
            this.commonService.err("All fields are required.");
            return;
        ...
        this.api.post("editPortfolio", data).subscribe(function (result) {
            if (result.status == 200) {
                _this.commonService.succ(result.message);
                _this.router.navigate(['portfolio-detail/', _this.portfolioFrom.value.portfolioId]);
            }
            else {
                _this.commonService.succ('Something went wrong');
            }
    ...
    PortfolioDetailEditComponent.ctorParameters = function () { return [
        { type: _angular_common__WEBPACK_IMPORTED_MODULE_3__["Location"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"] },
    ...
    return PortfolioDetailEditComponent;
}());
...
var PortfolioDetailComponent = /** @class */ (function () {
    function PortfolioDetailComponent(location, activatedRoute, router, api, commonService) {
        this.location = location;
        this.activatedRoute = activatedRoute;
        this.router = router;
        this.api = api;
    ...
    PortfolioDetailComponent.prototype.backClicked = function () {
        // localStorage.setItem("fromInvesting","true")
        this.location.back();
    };
    PortfolioDetailComponent.prototype.getPortfolioDetail = function () {
        var _this = this;
        this.activatedRoute.params.subscribe(function (params) {
            console.log(params['id']);
            _this.api.get('portfolioDetail/' + params['id']).subscribe(function (result) {
                ...
                if (result.status == 200) {
                    if (result.data) {
                        ...
                        console.log('this.thematicDetailthis.thematicDetail', _this.assignedModelDetail);
                    }
                }
                else {
                    _this.commonService.err(result.message);
...
var QuestionnaireComponent = /** @class */ (function () {
    function QuestionnaireComponent(api, spinner, commonService, router) {
        this.api = api;
        this.spinner = spinner;
        this.commonService = commonService;
        this.router = router;
    ...
    QuestionnaireComponent.prototype.getQuestionnaireList = function () {
        var _this = this;
        this.api.get('questionnaireList').subscribe(function (result) {
            //console.log('resultresultresult', result)
            if (result.status == 200) {
                _this.questionnaireList = result.data;
            }
            _this.spinner.hide();
        }, function (error) {
            console.log({ error: error });
    ...
    QuestionnaireComponent.prototype.deleteQuestionnaire = function (questionnaire) {
        var _this = this;
        console.log('paramsparamsparamsparams', questionnaire._id);
        this.api.delete('deleteQuestionnaire/' + questionnaire._id).subscribe(function (result) {
            //console.log('resultresultresult', result)
            if (result.status == 200) {
                _this.getQuestionnaireList();
            }
            else {
            }
        }, function (error) {
    ...
    QuestionnaireComponent.prototype.enableQuestionare = function (detail) {
        var _this = this;
        var data = {
            questionnaireId: detail._id
        };
        this.api.post("enableQuestionare", data).subscribe(function (result) {
            if (result.status == 200) {
                _this.commonService.succ(result.message);
                _this.getQuestionnaireList();
            }
...
var RaiseCashComponent = /** @class */ (function () {
    function RaiseCashComponent(location) {
        this.location = location;
    }
    RaiseCashComponent.prototype.ngOnInit = function () {
    };
    RaiseCashComponent.prototype.backClicked = function () {
        // localStorage.setItem("fromInvesting","true")
        this.location.back();
    };
    RaiseCashComponent.ctorParameters = function () { return [
        { type: _angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"] }
    ]; };
...
var ReportManagementComponent = /** @class */ (function () {
    function ReportManagementComponent() {
    }
...
var SelfDirectedDetailComponent = /** @class */ (function () {
    function SelfDirectedDetailComponent(_location) {
    ...
    SelfDirectedDetailComponent.prototype.ngOnInit = function () {
    };
    SelfDirectedDetailComponent.prototype.backClicked = function () {
        this._location.back();
    };
    SelfDirectedDetailComponent.ctorParameters = function () { return [
        { type: _angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"] }
    ]; };
    ...
    return SelfDirectedDetailComponent;
}());
...
var StaticContentManagmentComponent = /** @class */ (function () {
    function StaticContentManagmentComponent() {
    }
    StaticContentManagmentComponent.prototype.ngOnInit = function () {
    };
    ...
    return StaticContentManagmentComponent;
}());
...
var EtfsComponent = /** @class */ (function () {
    function EtfsComponent() {
    }
    EtfsComponent.prototype.ngOnInit = function () {
        $(document).on('click', 'button.minus', function () {
            $(this).parents('.inputBox').find('.formControl').attr('value', 0);
        });
    };
...
var SummaryComponent = /** @class */ (function () {
    ...
    SummaryComponent.prototype.randomizeArray = function (arg) {
        var array = arg.slice();
        var currentIndex = array.length, temporaryValue, randomIndex;
        while (0 !== currentIndex) {
            randomIndex = Math.floor(Math.random() * currentIndex);
    ...
    SummaryComponent.prototype.chart1 = function () {
        /* Chart code */
        // Themes begin
    ...
    SummaryComponent.prototype.chart2 = function () {
        /* Chart code */
        // Themes begin
        _amcharts_amcharts4_core__WEBPACK_IMPORTED_MODULE_2__["useTheme"](_amcharts_amcharts4_themes_animated__WEBPACK_IMPORTED_MODULE_4__["default"]);
        // Themes end
    ...
    SummaryComponent.prototype.chart3 = function () {
        /* Chart code */
        // Themes begin
        _amcharts_amcharts4_core__WEBPACK_IMPORTED_MODULE_2__["useTheme"](_amcharts_amcharts4_themes_animated__WEBPACK_IMPORTED_MODULE_4__["default"]);
        // Themes end
        // Create chart
        var chart = _amcharts_amcharts4_core__WEBPACK_IMPORTED_MODULE_2__["create"]("chartdivThree", _amcharts_amcharts4_charts__WEBPACK_IMPORTED_MODULE_3__["XYChart"]);
        chart.paddingRight = 20;
        chart.data = generateChartData();
        var dateAxis = chart.xAxes.push(new _amcharts_amcharts4_charts__WEBPACK_IMPORTED_MODULE_3__["DateAxis"]());
        dateAxis.baseInterval = {
...
var SupportMessageComponent = /** @class */ (function () {
    function SupportMessageComponent() {
    }
    SupportMessageComponent.prototype.ngOnInit = function () {
    };
    ...
    return SupportMessageComponent;
}());
...
var ThematicDetailComponent = /** @class */ (function () {
    function ThematicDetailComponent(location, api, activatedRoute, commonService, router, spinner) {
        this.location = location;
        this.api = api;
        this.activatedRoute = activatedRoute;
        this.commonService = commonService;
    ...
    ThematicDetailComponent.prototype.ngOnInit = function () {
        this.getThematicDetail();
    };
    ThematicDetailComponent.prototype.backClicked = function () {
        // localStorage.setItem("fromInvesting","true")
        this.location.back();
    };
    ThematicDetailComponent.prototype.getThematicDetail = function () {
        var _this = this;
        this.activatedRoute.params.subscribe(function (params) {
            console.log(params['id']);
            _this.api.get('thematicDetail/' + params['id']).subscribe(function (result) {
    ...
    ThematicDetailComponent.ctorParameters = function () { return [
        { type: _angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"] },
        { type: _api_api_service__WEBPACK_IMPORTED_MODULE_3__["Api"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"] },
        { type: _api_comman_service__WEBPACK_IMPORTED_MODULE_4__["CommonService"] },
    ...
    return ThematicDetailComponent;
}());
...
var WaitListComponent = /** @class */ (function () {
    function WaitListComponent(api) {
        this.api = api;
        this.waitUsers = [];
    }
    ...
    WaitListComponent.prototype.waitList = function () {
        var _this = this;
        this.api.get("waitList").subscribe(function (result) {
            if (result.status == 200) {
                _this.waitUsers = result.data;
            }
            else {
            }
        }, function (error) {
